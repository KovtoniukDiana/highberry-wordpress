...
<body>
    <div class="vacancy-all">
                    ...
                    if ( get_sub_field('block_page_id') === get_field('selected_top_page_block') ) :
                        ...
                        <div class="header-background"> 
                            <?php if ( $img ) : ?>
                                ...
                                alt="<?php echo esc_attr($img['alt'] ?: 'header background'); ?>">
                            <?php endif; ?>
                        </div>
        ...
        <div class="grey-background flex-wrapper">
            ...
            <div class="work-with-us grey-shadow-box flex-wrapper">
                <div class="first-row ">
                    <div class="image">
                        <?php if ( get_field('red_mini_logo', 'option') ) : ?>
                            <img 
                    ...
                    <div class="aplication flex-wrapper">

                        <div class="title">
                            <?php if ( get_field('aplication_title') ) : ?>
                                <p><?php the_field('aplication_title'); ?></p>
                            <?php endif; ?>   
                        </div>
                            ...
                            <?php if ( have_rows('form_input') ) : ?>
                                <?php while ( have_rows('form_input') ) : the_row(); ?>
                                    ...
                                    <?php if ( get_sub_field('input') ) : ?>
                                        <input type="text" placeholder="<?php the_sub_field('input'); ?>">
                                    <?php endif; ?>   
                        ...
                        <span class="flex-wrapper"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/vacancy/add-resume.png" alt=""> прикріпити резюме</span>
    
                        <?php if ( get_field('button_send') ) : ?>
                            <button><?php the_field('button_send'); ?></button>
                        <?php endif; ?>   
                    </div>
                </div>

                <div class="max-630 gorizontal-line"></div>
                
                <div class="title second">
                    <?php if ( get_field('form_contacts_title') ) : ?>
                        <p><?php the_field('form_contacts_title'); ?></p>
                    <?php endif; ?>   
                </div>
    
                <div class="contacts">

                    <?php if ( have_rows('form_contacts') ) : ?>
                        <?php while ( have_rows('form_contacts') ) : the_row(); ?>
                                
                            <?php if ( get_sub_field('item') ) : ?>
                                <div class="flex-wrapper">
                                    <p><?php echo nl2br(get_sub_field('item')); ?></p>
                                </div>
                            <?php endif; ?>   
